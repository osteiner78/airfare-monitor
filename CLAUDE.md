...
- **Current test suite**: `pytest tests/ -v -k "not slow"` → 158 passed, 1 deselected. Test files: test_airline_logo, test_api, test_best_price, test_chart_colors, test_chart_data, test_db, test_delta, test_filters, test_fingerprint, test_logging, test_normalization, test_notification_log, test_notifications, test_pages, test_sources.
